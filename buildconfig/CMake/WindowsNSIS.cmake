...
if(EXISTS "${PACKAGE_IMAGES_DIR}\\\\mantidplot${PACKAGE_ICON_BASENAME}.png")
  set(PACKAGE_ICON_SUFFIX ${CPACK_PACKAGE_SUFFIX})
else()
  set(PACKAGE_ICON_SUFFIX "unstable")
endif()

set(PACKAGE_ICON_BASENAME "mantidplot${PACKAGE_ICON_SUFFIX}")
...
# Notebook
set(WINDOWS_NSIS_MANTIDNOTEBOOK_ICON_NAME "mantid_notebook${PACKAGE_ICON_SUFFIX}")
...
if(ENABLE_WORKBENCH)
  ...
  set(WINDOWS_NSIS_MANTIDWORKBENCH_ICON_NAME "mantid_workbench${PACKAGE_ICON_SUFFIX}")
