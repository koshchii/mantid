...
# If the package icon doesn't exist use the unstable one
if(NOT EXISTS ${CPACK_PACKAGE_ICON})
  set(PACKAGE_ICON_BASENAME "mantidplotunstable")
  set(CPACK_PACKAGE_ICON "${PACKAGE_IMAGES_DIR}\\\\${PACKAGE_ICON_BASENAME}.png")
endif()
...
# Notebook
set(WINDOWS_NSIS_MANTIDNOTEBOOK_ICON_NAME "mantid_notebook${PACKAGE_ICON_BASENAME}")
...
if(ENABLE_WORKBENCH)
  ...
  set(WINDOWS_NSIS_MANTIDWORKBENCH_ICON_NAME "mantid_workbench${PACKAGE_ICON_BASENAME}")
