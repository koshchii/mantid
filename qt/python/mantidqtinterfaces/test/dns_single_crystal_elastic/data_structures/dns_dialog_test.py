...
class DNSDialogTest(unittest.TestCase):
    @classmethod
    @patch("mantidqtinterfaces.dns_single_crystal_elastic.data_structures.dns_dialog.loadUi")
    @patch("mantidqtinterfaces.dns_single_crystal_elastic.data_structures.dns_dialog.Path")
    def setUpClass(cls, mock_path, mock_load_ui):
        # pylint: disable=arguments-differ
        cls.path_parent = mock.Mock()
        cls.path_parent.absolute = mock.Mock()
        cls.path_parent.absolute.return_value = "456"
        mock_load_ui.return_value = "123"
        cls.mock_load_ui = mock_load_ui
