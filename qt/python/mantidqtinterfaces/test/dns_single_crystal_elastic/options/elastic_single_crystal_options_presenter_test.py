...
class DNSElasticSCOptionsPresenterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.view.get_state = mock.Mock(
            return_value={"wavelength": 4.74, "get_wavelength": False, "hkl1": "1,2,3", "hkl2": "2,3,4", "use_dx_dy": True}
        )

        cls.presenter = DNSElasticSCOptionsPresenter(
            view=cls.view, model=cls.model, parent=cls.parent, name="elastic_single_crystal_options"
        )
    ...
    def test_process_request(self, mock_wavel):
        ...
        self.view.get_state.return_value = {"wavelength": 4.74, "get_wavelength": True, "hkl1": "1,2,3", "hkl2": "2,3,4", "use_dx_dy": True}
        self.presenter.process_request()
    ...
    def test_process_commandline_request(self):
        ...
        self.view.set_single_state_by_name.assert_called_with("omega_offset", 1)
