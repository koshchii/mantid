...
class DNSElasticSCScriptGeneratorModelTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.sample_data.datadic = get_fake_elastic_data_dic()
        ...
        cls.standard_data.datadic = get_elastic_standard_data_dic()
    ...
    def test_script_maker(self, mock_dns_dataset):
        ...
        lines = [76, 113, 91, 65, 49, 0, 20, 22, 0, 307, 0, 109, 51, 71, 0, 45, 130, 0, 21, 250, 129]
    ...
    def test_setup_standard_data(self, mock_dns_dataset):
        ...
        mock_dns_dataset.return_value = self.standard_data
        self.model._setup_standard_data({"standards_dir": "123"}, {"standard_data": []})
    ...
    def test_get_header_lines(self):
        ...
        self.assertEqual(
            testv[0], "from mantidqtinterfaces.dns_single_crystal_elastic." "scripts.md_single_crystal_elastic import load_all"
        )
        self.assertEqual(
            testv[1],
        ...
        self.assertEqual(testv[3], "from mantid.simpleapi import ConvertMDHistoToMatrixWorkspace, mtd")
        self.assertEqual(testv[4], "from mantid.simpleapi import SaveAscii, SaveNexus")
    ...
    def test_get_load_data_lines(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "wss_standard = load_all(standar" "d_data, binning, params, standar" "d=True,)",
                "",
            ],
        )
        self.model._corrections = False
        testv = self.model._get_load_data_lines()
        self.assertEqual(testv, ["wss_sample = load_all(sample_data, binning, params)", ""])
    ...
    def test_get_plotlist(self, mtd):
        ...
        self.assertEqual(testv, (["4p1K_map"], {"4p1K_map": {"two_theta": [1, 2, 3], "omega": [4, 5, 6], "intensity": 4, "error": 1.0}}))
