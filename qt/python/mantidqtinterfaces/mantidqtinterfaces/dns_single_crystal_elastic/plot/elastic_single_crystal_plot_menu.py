...
from mantidqtinterfaces.dns_single_crystal_elastic.plot.colormaps.matplotcolors import colormaps
...
def set_up_colormap_selector(mapping):
    ...
    for m in colormaps:
        mapping["colormap"].addItem(QIcon(f"{plot_dir}/colormaps/{m}.png"), m)
